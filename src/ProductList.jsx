...
function ProductList({ onShowLandingPage }) {
    
    const cartItems = useSelector(state => state.cart.items);
    const dispatch = useDispatch();
    const [showCart, setShowCart] = useState(false); 
    const [showPlants, setShowPlants] = useState(false); // State to control the visibility of the About Us page
    const [addedToCart, setAddedToCart] = useState({}); // state to track things added to cart
   ...
   const handleParadiseNurseyClick = (e) => {
    if(e) e.preventDefault(); // Prevent the default anchor click behavior
